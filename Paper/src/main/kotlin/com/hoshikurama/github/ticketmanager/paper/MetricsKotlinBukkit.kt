...
/* Note: This is NOT my code. Converted bStats Java to Kotlin using IntelliJ */
class Metrics(plugin: JavaPlugin, serviceId: Int) {
    ...
    class MetricsBase(
        ...
        private fun submitData() {
            ...
            val chartData: Array<JsonObjectBuilder.JsonObject?> = customCharts
                .mapNotNull { it.getRequestJsonObject(errorLogger, logErrors) }
                .toTypedArray()
    ...
    class JsonObjectBuilder() {
        ...
        fun appendField(key: String?, values: IntArray?): JsonObjectBuilder {
            ...
            val escapedValues =
                Arrays.stream(values).mapToObj { i: Int -> i.toString() }.collect(Collectors.joining(","))
            appendFieldUnescaped(key, "[$escapedValues]")
            return this
        }
