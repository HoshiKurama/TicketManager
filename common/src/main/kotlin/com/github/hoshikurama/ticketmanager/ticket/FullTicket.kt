...
operator fun FullTicket.plus(action: FullTicket.Action): FullTicket {
    return FullTicket(id, creatorUUID, location, priority, status, assignedTo, creatorStatusUpdate, actions + action)
}